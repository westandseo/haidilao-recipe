(() => {
  ...
  const RECIPES = [
    ...
    { id: 'r3', date: '2024-09-22', cat: '밥', emoji: '🍚', img: 'assets/cards/희수국밥.jpg?v=1', imgFit: 'cover', tint: 'linear-gradient(160deg,#F5EFE0,#E5D6B8)', name: '희수국밥', source: 'X @snowdoesnot', desc: '메뉴 이름에서도 알 수 있듯이 창시자는 <b>희수</b>라는 인물이며, 유튜브 <b>햅삐찌링</b>에 본인등판하여 <u>버섯탕이 너무너무 맛있는데 국물에 밥을 말아 먹지 않는 게 이해가 되지 않아서 그때부터 밥을 말아 국밥처럼 먹었다</u>고 한다.',
